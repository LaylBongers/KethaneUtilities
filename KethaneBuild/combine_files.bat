...
IF EXIST KethaneRelease (GOTO :RELEASESUCCESS)
:RELEASEERROR
echo ERROR: KethaneRelease not found, check build instructions in README.md
GOTO :EXIT
:RELEASESUCCESS
...
xcopy KethaneRelease\*.wav ModFolder /e /i /q
xcopy KethaneRelease\*.mu ModFolder /e /i /q
xcopy KethaneRelease\*.mbm ModFolder /e /i /q
xcopy KethaneRelease\Plugins\PluginData ModFolder\Plugins\PluginData /e /i /q
